...
module Git
  class Lib
    ...
    def command(*args, out: nil, err: nil, normalize: true, chomp: true, merge: false)
      result = command_line.run(*args, out: out, err: err, normalize: normalize, chomp: chomp, merge: merge)
      result.stdout
    end
